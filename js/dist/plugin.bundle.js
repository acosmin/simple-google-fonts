...
/* harmony default export */ __webpack_exports__["default"] = (compose([withSelect(function (select) {
  ...
  return {
    ...
    updateHeadingsMeta: function updateHeadingsMeta(elements, newmeta) {
      ...
      var defaults = parsed("el:".concat(el, "|wt:400|tt:none|lh:1.4|ls:0"));
...
/*!*************************!*\
  !*** ./js/src/utils.js ***!
  \*************************/
/*! exports provided: capitalizeWords, newStyleLinkURL, reviewedData, parseHeadingValues, stringifyHeadingValues, getHeadingValue, createStyleNodes, addGlobalHeadings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getHeadingValue = function getHeadingValue(el, prop, meta) {
  var defaults = parseHeadingValues("el:".concat(el, "|wt:400|tt:none|lh:1.4|ls:0"));
  var headings = meta.sgf_els_headings;
...
var addGlobalHeadings = function addGlobalHeadings(meta) {
  var _simpleGFonts = simpleGFonts,
      gvals = _simpleGFonts.global_vals;
